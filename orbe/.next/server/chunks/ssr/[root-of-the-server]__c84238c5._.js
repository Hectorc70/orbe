...
"[project]/src/backend/abort_controller.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/backend/errors.util.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/common/constants.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/backend/userService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$abort_controller$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/abort_controller.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$errors$2e$util$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/errors.util.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/common/constants.ts [app-ssr] (ecmascript)");
;
;
;
;
...
const createUser = async (data)=>{
    ...
    const signal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$abort_controller$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAbortableRequest"])(key);
    try {
        debugger;
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseApi}/users/create/`, {
            email: data.email,
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isCancel(e) || e.name === "CanceledError" || e.name === "AbortError") {
            return Promise.reject(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$errors$2e$util$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CANCELLED_REQUEST"]);
        }
        throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$errors$2e$util$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleError"])(e);
    } finally{
        delete __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$abort_controller$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["controllers"][key];
    }
};
const login = async (email, password)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseApi}/users/login/`, {
            email,
            password
        });
        const { token, id } = response.data.data;
        setCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsToken"], token, {
            maxAge: 60 * 60 * 24 * 7,
            path: '/',
            secure: ("TURBOPACK compile-time value", "development") === 'production',
            sameSite: 'lax'
        });
        setCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsId"], id.toString(), {
            maxAge: 60 * 60 * 24 * 7,
            path: '/',
            secure: ("TURBOPACK compile-time value", "development") === 'production',
            sameSite: 'lax'
...
const getUser = async ()=>{
    try {
        const id = getCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsId"]) || '';
        const token = getCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsToken"]);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${baseApi}/users/get/${id}`, {
            headers: {
...
const sendUSDC = async (send_to, amount, typeSend)=>{
    ...
    try {
        const token = getCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsToken"]);
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseApi}/transactions/send/`, {
            send_to,
            amount,
            typeSend
        }, {
...
const swapNative = async (amount)=>{
    ...
    try {
        const token = getCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsToken"]);
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseApi}/transactions/swap/`, {
            amount
        }, {
            signal,
            headers: {
...
"[project]/src/components/ui/inputForm.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/dashboard/send/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$useGlobalStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/useGlobalStore.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/userService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/common/constants.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$errors$2e$util$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/errors.util.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/nextjs-toast-notify/dist/nextjs-toast-notify.es.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hook-form/dist/index.esm.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$inputForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/inputForm.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function SendPage() {
    ...
    const { user, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$useGlobalStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGlobalStore"])();
    ...
    const [recipientIdentifier, setRecipientIdentifier] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [totalDeducted, setTotalDeducted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const updateUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$useGlobalStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGlobalStore"])((state)=>state.updateUser);
    ...
    const [tab, setTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('orbe_user');
    ...
    const init = async ()=>{
        try {
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCookie"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lsToken"]) || '';
            if (token === '' && !isAuthenticated) {
            // router.push('/')
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getUser();
            updateUser(response);
            validateButton();
        } catch (error) {
            if (error != __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$errors$2e$util$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CANCELLED_REQUEST"]) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error(error?.toString?.() ?? 'Error desconocido');
            }
        }
        return null;
    };
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            if (recipientIdentifier === user?.walletAddress) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error('You cannot send funds to your own wallet');
                return;
            }
            if (recipientIdentifier === '') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error('Please enter a wallet address');
                return;
            }
            if (isNaN(amount)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error('Please enter an amount');
                return;
            }
            setIsSending(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].sendUSDC(recipientIdentifier, totalDeducted, typeSend);
            await init();
            setIsSending(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].success('Funds sent successfully', {
                position: 'top-center'
            });
            reset();
        } catch (error) {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$inputForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                        step: "0.01",
                                        label: "Amount (USDC)",
                                        type: "number",
                                        placeholder: "0.00",
                            ...
                            amountWatch > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c84238c5._.js.map