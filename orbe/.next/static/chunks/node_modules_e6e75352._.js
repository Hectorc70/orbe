...
"[project]/node_modules/nextjs-toast-notify/dist/nextjs-toast-notify.es.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const f = ()=>{
    ...
    const { message: o, type: a = "success" } = q, { duration: s = 8e3, progress: e = !0, position: r = "top-right", transition: i = "fadeIn", icon: c, sound: p } = A, l = M(r), t = document.createElement("div");
    t.classList.add("toast-nextjs", a), t.style.setProperty("--progress-duration", `${s}ms`), t.classList.add(`animate-${i || "fadeIn"}`);
    const m = c || ({
    ...
    })[a], d = a === "success" ? "#4caf50" : a === "error" ? "#f44336" : a === "warning" ? "#ff9800" : a === "info" ? "#2196f3" : "#fff";
    t.innerHTML = `
    <div class="toast-content">
      <i class="check" style="background-color: ${d};">
        ${m}
      </i>
      <div class="message">
...
typeof window < "u" && (window.showToast = k);
;
}}),
}]);

//# sourceMappingURL=node_modules_e6e75352._.js.map