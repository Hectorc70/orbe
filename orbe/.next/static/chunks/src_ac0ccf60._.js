...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login(data.email, data.password);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nextjs$2d$toast$2d$notify$2f$dist$2f$nextjs$2d$toast$2d$notify$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"].success('Login exitoso');
...
_s(LoginPage, "t8o4wJjP7VQu1czCFoKVUL2ExYI=", false, function() {
    return [
...
//# sourceMappingURL=src_ac0ccf60._.js.map