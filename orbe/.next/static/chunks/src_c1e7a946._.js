...
function SendPage() {
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            setIsSending(true);
            const typeSend = setTab === 'orbe_user' ? 1 : 0;
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].sendUSDC(recipientIdentifier, amount, 1);
            setIsSending(false);
...
_s(SendPage, "w9Mt4tX+rAjhNjqAB2pLkeWAOnE=", false, function() {
    return [
...
//# sourceMappingURL=src_c1e7a946._.js.map